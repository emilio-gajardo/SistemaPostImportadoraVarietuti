              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          ...
                          <br><br>
                          <p style="color: green">*En esta sección podrás ver y comprar a los  "Proveedores" y agregarlos al stock a la tienda.</p>
                            ...
                            <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                              <thead style="background-color:#A9D0F5">
                                ...
                                <tfoot>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th><h4 id="total">S/ 0</h4><input type="hidden" name="total_compra" id="total_compra"></th> 
                                </tfoot>
                                <tbody>
