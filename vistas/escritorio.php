            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <!-- centro -->
                    <div class="col-md-12">
                      <p style="color: green">Bienvenido al sistema de gestión de Importadora Varietuti.</p>
                      <p style="color: green">Aquí podrás observar un resumen de las compras y ventas del día.</p>
                    </div>
                    <br><br><br><br>
...
<!--librerias para mostrar graficos de barras en el escritorio-->
