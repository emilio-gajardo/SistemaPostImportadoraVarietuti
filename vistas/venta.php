              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          ...
                          <br><br>
                          <p style="color: green">*En esta sección podrás ver y generar ventas a los "Clientes".</p>
                    ...
                    <form name="formulario" id="formulario" method="POST">
                        ...
                        <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            ...
                            <select id="idcliente" name="idcliente" class="form-control selectpicker" required>
                            </select>
                          </div>
